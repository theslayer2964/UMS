function countChecked() {
    "all" === checkState && $(".bulk_action input[name='checkList']").iCheck("check"), "none" === checkState && $(".bulk_action input[name='checkList']").iCheck("uncheck");
    var e = $(".bulk_action input[name='checkList']:checked").length;
