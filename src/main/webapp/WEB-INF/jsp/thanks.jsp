...
<head>
    <meta charset="utf-8" />
    <title><spring:message code="system.title"/> | <spring:message code="msg.thanks.title"/></title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                ...
                <div class="text-center">
                    ...
                    <h1 class="display-3 mt-4" id="title"><spring:message code="msg.thanks.title"/></h1>
                    <p class="text-muted mt-4"><spring:message code="msg.thanks.content"/></p>
