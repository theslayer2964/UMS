...
<c:url var="formURL" value="/admin/register.html"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <form:password id="password" path="pojo.password" data-validate-length="6,8"
...
<%--                                <label for="displayName" class="control-label"><spring:message--%>
...
<%--                        <div class="col-md-12">--%>
<%--                            <div class="form-group no-margin">--%>
<%--                                <label for="accountType" class="control-label"><spring:message--%>
<%--                                        code="label.user.type"/> </label>--%>
<%--                                <form:select id="accountType" path="pojo.accountType" cssClass="form-control"--%>
<%--                                             required="required">--%>
...
<%--                        <div class="col-md-12">--%>
<%--                            <div class="form-group no-margin">--%>
<%--                                <label for="userGroupId" class="control-label"><spring:message--%>
<%--                                        code="label.url.group"/> </label>--%>
...
<%--                    </div>--%>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success waves-effect waves-light"><spring:message
