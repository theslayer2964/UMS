...
<c:url var="formURL" value="/admin/urlgroup-list.html" />
<html>
<head>
  <title><spring:message code="menu.system.url_group"/> </title>
</head>
<body>
  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box">
        ...
        <h4 class="page-title"><spring:message code="label.url_group.list"/></h4>
      </div>
    </div>
  </div>
  <!-- end page title -->
          ...
          <div class="table-responsive">
            <table id="datatable-buttons" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
              ...
              <tr>
                ...
                <th><spring:message code="label.url_group.code"/> </th>
                <th><spring:message code="label.url_group.name"/></th>
              ...
              <c:forEach items="${items.listResult }" var="r" varStatus="loop">
                <tr>
                  ...
                  <td class="table-action" width="10%">
                    <a class="btn btn-icon waves-effect waves-light btn-warning btn-sm" onclick="javascript: editForm('${r.urlGroupId}', '${r.code}', '${r.name }', '${r.description}');">
                      <i class="fas fa-wrench"></i>
                    </a>
                    <a class="btn btn-icon waves-effect waves-light btn-danger btn-sm deleteLink" id="${r.urlGroupId }" onclick="javascrip: deleteLink('${r.urlGroupId}')"><i class="fas fa-times"></i></a>
                  </td>
...
<script>
  $(document).ready(function() {
    ...
    <%--    if (result) {--%>
    <%--      $("<input type='hidden' name='pojo.urlGroupId' value='"+id+"'>").appendTo($("#listForm"));--%>
    <%--      $("#listForm").submit();--%>
    <%--    }--%>
    <%--  });--%>
    <%--});--%>
