...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/login.html").permitAll()
                ...
                .antMatchers("/guest/explanation-form.html").access("hasAnyRole('FAD_EXPLANATIONFORM','FAD_GUESTINFO','FAD_GUESTREQUEST','ADMIN')")
                .antMatchers("/guest/info.html").access("hasAnyRole('FAD_EXPLANATIONFORM','FAD_GUESTINFO','FAD_GUESTREQUEST','ADMIN')")
                .antMatchers("/guest/request-user.html").access("hasAnyRole('FAD_EXPLANATIONFORM','FAD_GUESTINFO','FAD_GUESTREQUEST','ADMIN')")
