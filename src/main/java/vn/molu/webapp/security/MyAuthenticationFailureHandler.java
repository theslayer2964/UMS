...
public class MyAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    private String defaultFailureUrl= "/login.html?error=1";
     ...
     * otherwise returns common.a 401 error code.
     * <p>
     ...
     * there is no session and {@code allowSessionCreation} is {@code true}
     * common.a session will be created. Otherwise the exception will not be
     * stored.
     */
    ...
    /**
     * If set to <tt>true</tt>, performs common.a forward to the failure
     * destination URL instead of common.a redirect. Defaults to <tt>false</tt>.
     */
    ...
    /**
     * Allows overriding of the behaviour when redirecting to common.a target
     * URL.
     */
